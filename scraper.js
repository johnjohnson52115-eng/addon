...
async function run() {
  try {
    ...
    // Standard .scrape() with a schema is much cheaper than .agent()
    ...
    console.log(`Success! Saved ${result.data.metas.length} movies at a low credit cost.`);
  } catch (error) {
